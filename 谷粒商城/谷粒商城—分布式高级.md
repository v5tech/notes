...
![](images/image-20200501195619925.png)

再次使用POST插入数据，仍然是新增的：

![](images/image-20200501195732492.png)



添加数据的时候，指定ID，会使用该id，并且类型是新增：

![](images/image-20200501200048361.png)

再次使用POST插入数据，类型为updated

![](images/image-20200501200132199.png)
...
![](images/image-20200501212224983.png)

 （2）将name更新为2，更新过程中使用seq_no=6

http://192.168.137.14:9200/customer/external/1?if_seq_no=6&if_primary_term=1 

![](images/image-20200501213047499.png)
...
![](images/image-20200501213130001.png)
...
![](images/image-20200501220559094.png)
